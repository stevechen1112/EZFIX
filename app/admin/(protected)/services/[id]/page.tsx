...
export default async function EditServicePage({ params }: { params: { id: string } }) {
  ...
  const featuresText = safeJsonParse<string[]>(service.features, []).join("\n");
  ...
  return (
    <div className="max-w-2xl space-y-6">
      ...
      <h1 className="text-2xl font-bold text-gray-900">編輯服務項目</h1>

      <form action={updateService.bind(null, id)} className="bg-white rounded-2xl shadow-card p-6 space-y-4">
        <div>
        ...
        <ImageUploader name="image" defaultValue={service.image} label="配圖" folder="services" />
